...
locals {
  ...
  #
  # The script carries no secret: the only one the provisioning service needs, the household
  # key, is generated on the VM and never passes through Terraform (see the module README).
